...
namespace CSE_WebEducation
{
    public class AllCodeMemory
    {
        ...
        //public static void EmailTemplate_ReloadMemory()
        //{
        //    try
        //    {
        //        List<Msg_Email_Template> _lst = ApiShare_Data.EmailTemplate_GetAll();
        //        lock (_locklstEmailTemplate)
        //        {
        //            lstEmailTemplate = _lst;
        //        }
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //public static Msg_Email_Template EmailTemplate_GetByCode(string code)
        //{
        //    try
        //    {
        //        return lstEmailTemplate.Where(x => x.Code.Equals(code)).SingleOrDefault();
        //    }
        //    catch (Exception ex)
        //    {
        //        Logger.log.Error(ex.ToString());
